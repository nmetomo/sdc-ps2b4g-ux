 ...
 */(function(factory){
	...
	var Datepicker = function(element, options){
		...
		if (this.o.calendarWeeks)
			this.picker.find('thead .datepicker-title, tfoot .today, tfoot .clear, tfoot .hide')
	...
	Datepicker.prototype = {
		...
		place: function(){
			...
			var left = offset.left - appendOffset.left + 10,    // 2016.11.21 とりあえず適当にずらす
				top = offset.top - appendOffset.top + 24;       // 2016.11.21 とりあえず適当にずらす
      ...
      var localDate = this._utc_to_local(this.viewDate);
		...
		fill: function(){
			var d = new Date(this.viewDate),
				...
				//2016.11.21 add_start umezaki
				hidetxt = dates[this.o.language].hide || dates['en'].hide || '',
				//2016.11.21 add_end   umezaki
	...
	var DPGlobal = {
		...
		footTemplate: '<tfoot>'+
							//2016.11.21 update_start umezaki
							'<tr>'+
								'<th colspan="7">'+
